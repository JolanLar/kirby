                ...
                <MediaCard
                  ...
                  hoverOverlay={
                    <button
                      ...
                      className="media-card-mobile-action px-4 py-2 bg-emerald-500 hover:bg-emerald-400 text-white rounded-lg transition-colors shadow-lg flex items-center gap-2 font-medium"
                    >
